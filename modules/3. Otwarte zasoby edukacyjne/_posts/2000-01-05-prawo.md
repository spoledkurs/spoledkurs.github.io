...
<div class="screen-content">
  ...
  <p>
      <ol>
        <li style="list-style-type:lower-alpha">oryginalny;</li>
        <li style="list-style-type:lower-alpha">zależny - czyli taki, który powstał z wykorzystaniem innego utworu (np. tłumaczenie, kolaż);</li>
        <li style="list-style-type:lower-alpha">inspirowany - czyli taki, który powstał dzięki inspiracji innym utworem (w tę kategorię wpada również parodia i pastisz).</li>
        </ol></p>
