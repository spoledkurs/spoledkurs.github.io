...
<div class="screen-content">
  ...
  <p>
      <ul type="bullet">
        <li>Musi to być rezultat <strong>pracy człowieka</strong>.</li>
        <li>Musi to być przejaw działalności twórczej.</li>
        <li>Musi mieć <strong>indywidualny charakter</strong>.</li>
        </ul>
        </p>
  ...
  <p>
      <ol type="a">
        <li>oryginalny;</li>
        <li>zależny - czyli taki, który powstał z wykorzystaniem innego utworu (np. tłumaczenie, kolaż);</li>
        <li>inspirowany - czyli taki, który powstał dzięki inspiracji innym utworem (w tę kategorię wpada również parodia i pastisz).</li>
        </ol></p>
